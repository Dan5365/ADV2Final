...
import (
	...
	"github.com/final/booking-service/internal/server"
	migrations "github.com/final/booking-service/migrations"
	"google.golang.org/grpc"
)

func main() {
	dsn := getenv("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/bookings?sslmode=disable")
	...
	bookingpb.RegisterBookingServiceServer(srv, server.New(repo, ch))
